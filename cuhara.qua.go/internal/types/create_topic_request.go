...
// ContextValidate validates this create topic request based on context it is used
func (m *CreateTopicRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
