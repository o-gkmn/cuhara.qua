-- +migrate Down
-- Revert all primary and foreign keys from BIGINT to INTEGER
...
-- Change primary keys back to INTEGER
...
ALTER TABLE topics ALTER COLUMN id TYPE INTEGER;
ALTER TABLE sub_topics ALTER COLUMN id TYPE INTEGER;
ALTER TABLE posts ALTER COLUMN id TYPE INTEGER;
ALTER TABLE answers ALTER COLUMN id TYPE INTEGER;
ALTER TABLE comments ALTER COLUMN id TYPE INTEGER;
ALTER TABLE tags ALTER COLUMN id TYPE INTEGER;
ALTER TABLE votes ALTER COLUMN id TYPE INTEGER;
ALTER TABLE claims ALTER COLUMN id TYPE INTEGER;

-- Change foreign keys back to INTEGER
ALTER TABLE users ALTER COLUMN role_id TYPE INTEGER;
ALTER TABLE users ALTER COLUMN tenant_id TYPE INTEGER;
ALTER TABLE roles ALTER COLUMN tenant_id TYPE INTEGER;
ALTER TABLE topics ALTER COLUMN tenant_id TYPE INTEGER;
ALTER TABLE sub_topics ALTER COLUMN topic_id TYPE INTEGER;
ALTER TABLE sub_topics ALTER COLUMN tenant_id TYPE INTEGER;
ALTER TABLE posts ALTER COLUMN creator_id TYPE INTEGER;
ALTER TABLE posts ALTER COLUMN subtopic_id TYPE INTEGER;
ALTER TABLE posts ALTER COLUMN tenant_id TYPE INTEGER;
ALTER TABLE answers ALTER COLUMN creator_id TYPE INTEGER;
ALTER TABLE answers ALTER COLUMN post_id TYPE INTEGER;
ALTER TABLE answers ALTER COLUMN tenant_id TYPE INTEGER;
ALTER TABLE comments ALTER COLUMN sender_id TYPE INTEGER;
ALTER TABLE comments ALTER COLUMN answer_id TYPE INTEGER;
ALTER TABLE comments ALTER COLUMN tenant_id TYPE INTEGER;
ALTER TABLE tags ALTER COLUMN tenant_id TYPE INTEGER;
ALTER TABLE votes ALTER COLUMN voter_id TYPE INTEGER;
ALTER TABLE votes ALTER COLUMN answer_id TYPE INTEGER;
ALTER TABLE votes ALTER COLUMN tenant_id TYPE INTEGER;
ALTER TABLE claims ALTER COLUMN tenant_id TYPE INTEGER;
