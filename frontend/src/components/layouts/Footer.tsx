...
export default function Footer() {
    return (
        <footer className="bg-gradient-to-tr from-slate-900 via-slate-900/95 to-slate-900/90 border-t border-slate-800/80">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-slate-400 text-sm mb-4 max-w-md">
                            ...
                            Featuring a robust backend API and intuitive user interface.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link to="/table" className="text-slate-400 hover:text-emerald-400 transition-colors text-sm">
                                    Table
                                </Link>
                            </li>
                            <li>
                ...
                <div className="border-t border-slate-800/80 mt-8 pt-6">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p className="text-slate-400 text-sm">
                            © {new Date().getFullYear()} cuhara.qua. All rights reserved.
                        </p>
