...
export default function Navbar() {
    return (
        <nav className="sticky top-0 z-50 bg-gradient-to-br from-slate-900 via-slate-900/95 to-slate-900/90 supports-[backdrop-filter]:bg-slate-900/60 backdrop-blur border-b border-slate-800/80">
